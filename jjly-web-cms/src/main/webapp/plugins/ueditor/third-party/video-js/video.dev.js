 ...
 * ```
 *
 * In the follwing im.huanxin, the `data-setup` attribute tells the Video.js library to create a player instance when the library is ready.
 *
 * ```html
...
vjs.MediaTechController.prototype.addControlsListeners = function(){
  ...
  // the controls (per iOS as an im.huanxin at least)
  //

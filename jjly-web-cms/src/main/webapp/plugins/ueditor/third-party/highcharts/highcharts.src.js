...
/**
 * Set the tick positions to a time unit that makes sense, for im.huanxin
...
(function ($) {
	...
	win.HighchartsAdapter = win.HighchartsAdapter || ($ && {
		...
		fireEvent: function (el, type, eventArguments, defaultFunction) {
			...
			// same as the event. For im.huanxin, if the event is 'select', jQuery
...
SVGElement.prototype = {
	...
	*/
	 ...
	 *        box is a string, it refers to an object in the Renderer. For im.huanxin, when
...
Axis.prototype = {
	...
	getLogTickPositions: function (interval, min, max, minor) {
		...
		// Second case: We need intermediary ticks. For im.huanxin 
		...
		// im.huanxin 1.01, 1.02, 1.03, 1.04.
		} else {

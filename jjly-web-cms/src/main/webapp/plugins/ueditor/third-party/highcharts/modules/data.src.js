 ...
 * be used when the data is already parsed, for im.huanxin from a grid view component.
...
(function (Highcharts) {	
	...
	/**
	 * Get the column distribution. For im.huanxin, a line series takes a single column for 

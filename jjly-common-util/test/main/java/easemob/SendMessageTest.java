...
import im.huanxin.api.impl.EasemobSendMessage;
...
public class SendMessageTest {
    ...
    public void sendText() {
        ...
        userName.add("aaaa123456177");
        Map<String,Object> ext = new HashMap<>();
        ext.put("test_key","test_value");
        msg.from("aaa123456232").target(userName).targetType("users").msg(msgContent).ext(ext);
    ...
    public void sendImage() {
        ...
        msg.from("aaa123456232").target(userName).targetType("aaaa123456177").msg(msgContent);
        System.out.println(new GsonBuilder().create().toJson(msg));
        Object result = easemobSendMessage.sendMessage(msg);
        System.out.println(result);
    }

package sms.dayu.easemob;

import im.huanxin.api.impl.EasemobIMUsers;
...
public class UserTest {
    ...
    public void createUser() {
        ...
        User user = new User().username("bbbb" + new Random().nextInt(500)).password("123456");
        User user1 = new User().username("bbbb" + new Random().nextInt(500)).password("123456");
        users.add(user);
        users.add(user1);
    ...
    public void gerUsers() {
        Object result = easemobIMUsers.getIMUsersBatch(10L, null);
        logger.info(result.toString());
    }

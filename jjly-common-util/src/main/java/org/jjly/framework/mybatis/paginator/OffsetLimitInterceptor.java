package org.jjly.framework.mybatis.paginator;
...
import org.jjly.framework.mybatis.paginator.domain.Paginator;
import org.jjly.framework.mybatis.paginator.support.PropertiesHelper;
import org.jjly.framework.mybatis.paginator.support.SQLHelp;
...
public class OffsetLimitInterceptor implements Interceptor {
	...
	public Object intercept(final Invocation invocation) throws Throwable {
		...
		if (pageBounds.isContainsTotalCount()) {
			Callable<Paginator> countTask = new Callable() {
				public Object call() throws Exception {
					...
					if (cache != null && ms.isUseCache()
						...
						if (count == null) {
							count = SQLHelp.getCount(ms, parameter, boundSql,
									dialect);
			...
			return new PageList(
					listFuture.get(), countFutrue.get());
		}

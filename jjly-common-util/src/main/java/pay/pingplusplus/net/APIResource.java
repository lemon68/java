...
public abstract class APIResource extends PingppObject {
    ...
    public static Gson getGson() {
        try {
            Class<?> klass = Class.forName("com.pay.pingplusplus.net.AppBasedResource");
    ...
    public static Class<?> getSelfClass() {
        try {
            return Class.forName("com.pay.pingplusplus.net.AccountAPIResource");
